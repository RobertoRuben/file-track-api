...
from src.app.domain.location.repository.interface import IHamletRepository
from src.app.domain.location.repository.implementations import HamletRepositoryImpl
