...
@router.delete(
    ...
    description="Deletes multiple roles from the system using a list of IDs. This operation is "
    "irreversible and may affect user associations. All specified roles must exist for the "
